...
// const toBool = (val: string | undefined, fallback: boolean = false): boolean => {
...
//   onProxyRes: (proxyRes: any, req: any) => any;
// }

// function buildCommonOptions(target: string): ProxyOptions {
//   return {
...
//       return responseInterceptor(proxyRes, req, (body: any, encoding: any) => {
//         return body;
//       });
//     },
//   };
